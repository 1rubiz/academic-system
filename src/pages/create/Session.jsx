  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <Card className="p-4 space-y-2">
        ...
        <div className="bg-green-600 hover:bg-green-700 w-full rounded-md py-2 flex items-center justify-center text-white" onClick={handleAddSession}>Add Session</div>
      </Card>
