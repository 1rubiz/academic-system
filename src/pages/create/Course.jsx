  ...
  return (
    <div className="max-w-2xl mx-auto p-4 space-y-6">
      ...
      <div className="grid grid-cols-6 gap-2 items-center">
        ...
        />
        <div className="bg-green-600 col-span-6 hover:bg-green-700 w-full rounded-md py-2 flex items-center justify-center text-white" onClick={handleAdd}>Add Course</div>
      </div>
