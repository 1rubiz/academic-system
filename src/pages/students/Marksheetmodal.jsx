...
export default function MarksheetModal({ open, onClose, courses, session, department, facultyName }) {
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="p-6 space-y-4">
        <DialogHeader className='text-white'>Generate Marksheet</DialogHeader>
