...
export const sessionAPI = {
  ...
  removeCourseFromSemester: (semesterId, courseId)=> ipcRenderer.invoke('remove-course-from-semester', semesterId, courseId),

  getSemesterCourses: (semesterId) =>
    ipcRenderer.invoke("get-semester-courses", semesterId),
