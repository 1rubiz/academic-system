...
export const studentAPI = {
  ...
  updateStudent: (id, updates) =>
    ipcRenderer.invoke("update-student", id, updates),

  deleteStudent: (id) => ipcRenderer.invoke("delete-student", id),

  suspendStudent: (id) => ipcRenderer.invoke("suspend-student", id),

  getStudentByLevelAndDept: (departmentId, level)=> ipcRenderer.invoke('get-students-by-department-and-level', departmentId, level),

  bulkUpload: (students, faculty_id, departmentId)=> ipcRenderer.invoke('bulk-upload-students', students, faculty_id, departmentId),

  setStudentLevelActive: (id, level)=> ipcRenderer.invoke('set-student-level-active', id, level),

  markLevelComplete: (id, level, value)=> ipcRenderer.invoke('mark-level-complete', id, level, value),
